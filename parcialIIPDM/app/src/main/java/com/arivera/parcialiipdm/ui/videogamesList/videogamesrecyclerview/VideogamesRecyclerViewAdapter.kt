...
class VideogamesRecyclerViewAdapter(private val clickListener: (VideogameModel) -> Unit): RecyclerView.Adapter<VideogamesRecyclerViewHolder>() {
    private val videogamesArray = ArrayList<VideogameModel>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VideogamesRecyclerViewHolder {
    ...
    override fun getItemCount(): Int = videogamesArray.size
